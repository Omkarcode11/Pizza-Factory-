...
export interface PizzaRepository  {
  ...
  updatePizza(id: string, pizza: Partial<PizzaInstance>): Promise<PizzaDto | null>;
  addStuffingToPizza(pizzaId: string, stuffingId: string): Promise<PizzaDto | null>;
  removeStuffingFromPizza(pizzaId: string, stuffingId: string): Promise<PizzaDto | null>;
